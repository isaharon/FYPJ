...
/* FYPJ Global variables for augmented afl-fuzz edits */
...
int main(int argc, char** argv) {
  ...
  // FYPJ Edits for augmented afl-fuzz
  ...
  // pFuncDiff
  pFuncDiff = PyDict_GetItemString(pDict, "diff");
  if (!pFuncDiff)
  {
      PyErr_Print();
      printf("ERROR in pFuncDiff\n");
      exit(1);
  }
  ...
  while (1) {
    ...
    // FYPJ insert python function querymodel
